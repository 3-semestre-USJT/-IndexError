...
def exibir_menu_principal(tela, desenhar_texto_func, fontes, opcao_selecionada):
    ...
    desafios_possiveis = [
        ...
        "Alcançar 10000 pontos",
        "Alcançar 25000 pontos",
        "Fazer combo de 100",
        "Fazer combo de 500",
        "Fazer combo de 1000",
        "Fazer combo de 2000",
        ...
        "30 acertos sem errar",
        "Completar 50 acertos",
        "Completar 100 acertos",
        "Completar 200 acertos",
        "Jogar 5 partidas",
        "Jogar 10 partidas",
        "Jogar 20 partidas",
        "Jogar 50 partidas",
        ...
        "Usar 10 powerups",
        "Usar 25 powerups",
        "Completar em Difícil",
        "Alcançar nível 10",
        "Alcançar nível 25",
        "Alcançar nível 50",
        "Terminar com 3 vidas",
        "Terminar com 1 vida",
        "Time Attack: 30 desafios",
        "Time Attack: 50 desafios",
        "Responder em < 5s",
        "Responder em < 3s"
    ]
